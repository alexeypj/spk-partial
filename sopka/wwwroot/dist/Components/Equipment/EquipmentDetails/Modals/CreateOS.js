...
let CreateOS = class CreateOS extends Vue {
    constructor() {
        super(...arguments);
        this.model = {
            Id: 0,
...
], CreateOS.prototype, "storeImpl", void 0);
__decorate([
    Prop({ required: true })
], CreateOS.prototype, "SaveHandler", void 0);
__decorate([
    Getter(Getters.IS_SAVING, { namespace: namespace })
], CreateOS.prototype, "IsSaving", void 0);
CreateOS = __decorate([
    Component
], CreateOS);
export default CreateOS;
//# sourceMappingURL=CreateOS.js.map