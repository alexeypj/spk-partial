...
let CreateMemory = class CreateMemory extends Vue {
    constructor() {
        super(...arguments);
        this.model = {
            Id: 0,
...
], CreateMemory.prototype, "storeImpl", void 0);
__decorate([
    Prop({ required: true })
], CreateMemory.prototype, "SaveHandler", void 0);
__decorate([
    Getter(Getters.IS_SAVING, { namespace: namespace })
], CreateMemory.prototype, "IsSaving", void 0);
CreateMemory = __decorate([
    Component
], CreateMemory);
export default CreateMemory;
//# sourceMappingURL=CreateMemory.js.map