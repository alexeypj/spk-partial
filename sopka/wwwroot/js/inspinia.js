...
$(document).ready(function () {
    ...
    */
    ...
    function setCollapseMenuButtonTitle() {
        if ($("body").hasClass("mini-navbar")) {
            $(".navbar-minimalize").attr("title", "Раскрыть меню");
        }
        else {
            $(".navbar-minimalize").attr("title", "Скрыть меню");
        }
    }
    ...
    $(document).on("click", function (event) {
        var $trigger = $(".nav.nav-second-level.collapse.in");
