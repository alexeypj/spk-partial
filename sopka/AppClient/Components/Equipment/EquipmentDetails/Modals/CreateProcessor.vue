<template>
	<div class="form-horizontal">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="text" v-model="model.Manufacturer"
		...
		<Footer :IsSaving="IsSaving" @store="store" @cancel="$emit('cancel', true)"/>		
	</div>
</template>

<script lang="ts" src="./CreateProcessor.ts" />