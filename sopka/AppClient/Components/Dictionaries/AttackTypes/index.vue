    ...
    <div class="minhtablerow">
                ...
                <div class="ibox-tools">
                    <div class="ibox-tools">
                        ...
                        <a @click="onAddClick"
                           ...
                           data-toggle="tooltip"
                           title="Добавить новый тип атаки">
        ...
        <Modal @cancel="closeModal"
            ...
            <EditForm slot="body"
                      ...
                      :OnAddCriticality="openCriticalityModal"/>
        </Modal>
        ...
        <Modal @cancel="closeCriticalityModal"
               v-show="showCriticalityModal"
               okText="Сохранить"
               :showFooter="false"
               title="Добавить критичность">
            <CreateCriticality slot="body"
                               @cancel="closeCriticalityModal"
                               :SaveHandler="onCriticalitySaved" />
        </Modal>
